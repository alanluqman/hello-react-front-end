...
This Generate random greeting messages , built with react-redux.
...
## Back-End side <a name="live-demo"></a>

- [Back-End](https://github.com/alanluqman/hello-rails-back-end)
...
```sh
  cd my-folder
  git clone https://github.com/alanluqman/hello-rails-front-end.git
```
